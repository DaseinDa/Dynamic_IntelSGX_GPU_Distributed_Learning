...
{
	double input[BATCHSIZE][INPUT][LENGTH_FEATURE0][LENGTH_FEATURE0];//32
	double layer1[BATCHSIZE][LAYER1][LENGTH_FEATURE1][LENGTH_FEATURE1];//28
	double layer2[BATCHSIZE][LAYER2][LENGTH_FEATURE2][LENGTH_FEATURE2];//14
	double layer3[BATCHSIZE][LAYER3][LENGTH_FEATURE3][LENGTH_FEATURE3];//10
	double layer4[BATCHSIZE][LAYER4][LENGTH_FEATURE4][LENGTH_FEATURE4];//5
	double layer5[BATCHSIZE][LAYER5][LENGTH_FEATURE5][LENGTH_FEATURE5];//1
