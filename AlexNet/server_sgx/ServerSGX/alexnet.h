...
#define LENGTH_FEATURE5_2	LENGTH_FEATURE5_1/2 //(7-3)/2 +1 = 3 no padding
...
typedef struct Feature
{
	...
	double layer1_conv[BATCHSIZE][LAYER1][LENGTH_FEATURE1_1][LENGTH_FEATURE1_1];
	double layer1_pool[BATCHSIZE][LAYER1][LENGTH_FEATURE1_2][LENGTH_FEATURE1_2];

	double layer2_conv[BATCHSIZE][LAYER2][LENGTH_FEATURE2_1][LENGTH_FEATURE2_1];
	double layer2_pool[BATCHSIZE][LAYER2][LENGTH_FEATURE2_2][LENGTH_FEATURE2_2];

	double layer3_conv[BATCHSIZE][LAYER3][LENGTH_FEATURE3_1][LENGTH_FEATURE3_1];
	
	double layer4_conv[BATCHSIZE][LAYER4][LENGTH_FEATURE4_1][LENGTH_FEATURE4_1];


	double layer5_conv[BATCHSIZE][LAYER5][LENGTH_FEATURE5_1][LENGTH_FEATURE5_1];//256*7*7
	double layer5_pool[BATCHSIZE][LAYER5][LENGTH_FEATURE5_2][LENGTH_FEATURE5_2];//256*3*3

	double fc1[BATCHSIZE][FC1_OUTPUT];
	double fc2[BATCHSIZE][FC2_OUTPUT];
	double output[BATCHSIZE][FC3_OUTPUT];
...
{
	double input[INPUT][LENGTH_FEATURE0+2*PADDING][LENGTH_FEATURE0+2*PADDING];//padding 2
