...
#define FILE_TRAIN_IMAGE		"/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/data/train-images-idx3-ubyte"
#define FILE_TRAIN_LABEL		"/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/data/train-labels-idx1-ubyte"
#define FILE_TEST_IMAGE		"/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/data/t10k-images-idx3-ubyte"
#define FILE_TEST_LABEL		"/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/data/train-labels-idx1-ubyte"
...
/*SGX enclave 初始化*/
    ...
    // std::vector<double> sendv(1000);
    // sendVector(0,sendv);
    // //synchronize(10000, 2); // wait for everyone to show up :)

    std::string weight_npy_file="/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/global_memory/weight.npy";
    std::string bias_npy_file = "/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/global_memory/bias.npy";
    std::string data_npy_file = "/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/global_memory/data.npy";
    std::string outerror_npy_file = "/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/global_memory/outerror.npy";
    std::string wd_npy_file = "/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/global_memory/weight_delta.npy";
    std::string bd_npy_file = "/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/global_memory/bias_delta.npy";
    std::string input_npy_file = "/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/global_memory/input.npy";

    std::string inerror_npy_file = "/home/jin/2023_11_22_com_model/LeNet_GPU_SGX/server_sgx_old/ServerSGX/global_memory/inerror.npy";
...
/* C++ NPY转换*/
   ...
   grad_maxpool(global_server_eid,((double*)errors.layer2),((double*)errors.layer1),((double*)features.layer1),GETLENGTH(*errors.layer1),GETLENGTH(**errors.layer1),GETCOUNT(errors.layer2),GETCOUNT(errors.layer1));
    ...
    grad_relu(global_server_eid,((double*)errors.layer1),GETCOUNT(errors.input));
    /*outerror读取到文件*/
