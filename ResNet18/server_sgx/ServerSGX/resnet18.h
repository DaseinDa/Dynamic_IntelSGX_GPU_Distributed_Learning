...
{
	double conv1_1[BATCHSIZE][LAYER1][Res1][Res1];
	double conv1_2[BATCHSIZE][LAYER1][Res1][Res1];

	double conv2_1[BATCHSIZE][LAYER1][Res1][Res1];
	double conv2_2[BATCHSIZE][LAYER1][Res1][Res1];
}Res1_Feature;


typedef struct Res2_Feature
{
	double conv1_1[BATCHSIZE][LAYER2][Res2][Res2];
	double conv1_2[BATCHSIZE][LAYER2][Res2][Res2];

	double conv_res[BATCHSIZE][LAYER2][Res2][Res2];

	double conv2_1[BATCHSIZE][LAYER2][Res2][Res2];
	double conv2_2[BATCHSIZE][LAYER2][Res2][Res2];
}Res2_Feature;

typedef struct Res3_Feature
{
	double conv1_1[BATCHSIZE][LAYER3][Res3][Res3];
	double conv1_2[BATCHSIZE][LAYER3][Res3][Res3];

	double conv_res[BATCHSIZE][LAYER3][Res3][Res3];

	double conv2_1[BATCHSIZE][LAYER3][Res3][Res3];
	double conv2_2[BATCHSIZE][LAYER3][Res3][Res3];
}Res3_Feature;

typedef struct Res4_Feature
{
	double conv1_1[BATCHSIZE][LAYER4][Res4][Res4];
	double conv1_2[BATCHSIZE][LAYER4][Res4][Res4];

	double conv_res[BATCHSIZE][LAYER4][Res4][Res4];

	double conv2_1[BATCHSIZE][LAYER4][Res4][Res4];
	double conv2_2[BATCHSIZE][LAYER4][Res4][Res4];
}Res4_Feature;
...
{
	double input[BATCHSIZE][INPUT][LENGTH_FEATURE0][LENGTH_FEATURE0];
	double conv1[BATCHSIZE][LAYER0][LENGTH_FEATURE0][LENGTH_FEATURE0];
	double pool1[BATCHSIZE][LAYER0][16][16];
	Res1_Feature res1f;
	Res2_Feature res2f;
	Res3_Feature res3f;
	Res4_Feature res4f;

	double pool2[BATCHSIZE][LAYER4][pool2_size][pool2_size];
	double output[BATCHSIZE][OUTPUT];
