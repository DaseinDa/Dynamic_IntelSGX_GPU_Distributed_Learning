...
void grad_maxpool_2_sgx(double* data_outerror, double* data_inerror, double* data_input, int* shape_input, size_t n_out, size_t n_in);
void grad_maxpool_str_sgx(double* data_outerror, double* data_inerror, double* data_input, int* shape_input, size_t n_out, size_t n_in, size_t kernel_size, size_t stride);
void test(void);
